<html>
    ...
    <body>
        ...
        <script src="/assets/js/lib/framework/utils/ColorUtils.js"></script>
        <script src="/assets/js/lib/framework/utils/Utils.js"></script>
        <script src="/assets/js/lib/framework/utils/Trace.js"></script>
        <script src="/assets/js/lib/framework/utils/assets/AssetManager.js"></script>
        <script src="/assets/js/lib/framework/utils/assets/BrowserDetect.js"></script>

    	  <script src="/assets/js/lib/framework/events/CEvent.js"></script>
        <script src="/assets/js/lib/framework/events/EventDispatcher.js"></script>
        <script src="/assets/js/lib/framework/events/ModelEvent.js"></script>
        <script src="/assets/js/lib/framework/events/PageEvent.js"></script>
        <script src="/assets/js/lib/framework/events/PageManagerEvent.js"></script>
        <script src="/assets/js/lib/framework/controller/ViewAddress.js"></script>
        <script src="/assets/js/lib/framework/controller/HistoryAddress.js"></script>
		...
		<script src="/assets/js/lib/framework/structure/StructureObj.js"></script>
		<script src="/assets/js/lib/framework/structure/StructureUtils.js"></script>
		<!--min
    	<script src="flashovy.min.js"></script>
		-->
    	<!--utils -->
    	<script src="/assets/js/utils/Dom.js"></script>
		<script src="/assets/js/utils/Math2.js"></script>
