<html>
    ...
    <body>
        ...
        <script src="../../src/framework/utils/assets/BrowserDetect.js"></script>

    	<script src="../../src/framework/events/CEvent.js"></script>
        <script src="../../src/framework/events/EventDispatcher.js"></script>
        <script src="../../src/framework/events/ModelEvent.js"></script>
        <script src="../../src/framework/events/PageEvent.js"></script>
        <script src="../../src/framework/events/PageManagerEvent.js"></script>
        <script src="../../src/framework/controller/ViewAddress.js"></script>
        <script src="../../src/framework/model/Model.js"></script>
        <script src="../../src/framework/view/View.js"></script>
        <script src="../../src/framework/view/page/Page.js"></script>
        <script src="../../src/framework/view/pageManager/PageManager.js"></script>
        <script src="../../src/framework/controller/AddressController.js"></script>
